...
2D пространство с гиперболической геометрией обозначается как H<sup>2</sup>, аналогично 3D как H<sup>2</sup>. Обычное евклидово пространство обозначается буквой E, например: E, E<sup>2</sup>, E<sup>3</sup>, E<sup>4</sup>.

Здесь будет систематизироваться интересный материал из чатика: https://t.me/metageometria

Рейтрейсинг в гиперболической геометрии: https://www.youtube.com/watch?v=ivHG4AOkhYA

Статья с красивыми картинками: http://page.math.tu-berlin.de/~sullivan/L/03W/Vis/curved-sp.pdf

Лекция про [замощения](https://ru.wikipedia.org/wiki/%D0%97%D0%B0%D0%BC%D0%BE%D1%89%D0%B5%D0%BD%D0%B8%D0%B5_(%D0%B3%D0%B5%D0%BE%D0%BC%D0%B5%D1%82%D1%80%D0%B8%D1%8F)) на гиперболической плоскости: https://www.youtube.com/watch?v=YpKWa8vrULk
...
Ещё раз: **здесь параллельные прямые не пересекаются, это их определение!**
...
[![](https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/Klein_model.svg/1024px-Klein_model.svg.png)](https://ru.wikipedia.org/wiki/%D0%93%D0%B5%D0%BE%D0%BC%D0%B5%D1%82%D1%80%D0%B8%D1%8F_%D0%9B%D0%BE%D0%B1%D0%B0%D1%87%D0%B5%D0%B2%D1%81%D0%BA%D0%BE%D0%B3%D0%BE#/media/%D0%A4%D0%B0%D0%B9%D0%BB:Klein_model.svg)
...
У меня есть желание сделать майнкрафт в H<sup>3</sup>, используя замощение пространства кубами [{4, 3, 5}](https://en.wikipedia.org/wiki/nOrder-5_cubic_honeycomb).
...
Второй пункт выбрала игра [HyperRogue](http://www.roguetemple.com/z/hyper/), но она находится на 2D плоскости. Видео: https://www.youtube.com/watch?v=xAFrKKApHTY
...
А это значит, что на расстоянии у нас будет помещаться e<sup>20</sup> блоков, следовательно вдалеке мы будем видеть мир очень сжатым. И движение по такому миру будет выглядеть не как обычное движение, а как зумирование, ведь всё будет очень быстро увеличиваться в размерах.

https://www.youtube.com/watch?v=twrn6CW-szo
...
[Статья](https://www.physicsforums.com/threads/coordinates-in-hyperbolic-geometry.311320/)
